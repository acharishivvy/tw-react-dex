      ...
      <div className="bg-gradient-to-r from-pink-300 to-indigo-300 ">
        <div className="container mx-auto">
          <div className="flex flex-col">
            ...
            {/* Height */}
            {/* Weight */}
            <div className="flex flex-col min-w-0 w-full mb-6 shadow-lg rounded-lg bg-pink-500">
              <h1>
                <bold>Pokedex Data</bold>
              </h1>
            ...
            {/* Growth Speed */}
            {/* Gender Ratio*/}
            <div className="flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
              <h1>Breeding Data</h1>
              ...
              <p>
                {evoChain.map((evo) => {
                  switch (evo.trigger_name) {
                    case "level-up":
                      return (
                        <>
                          ...
                          <li>
                            {!evo.min_level ? null : `at ${evo.min_level}`}
                          </li>
                          <li>
                          ...
                          <li>
                            {!evo.gender ? null : evo.gender ? 2 : "male"}
                          </li>
                        </>
                      );
                    case "trade":
                    ...
                    case "shed":
                      return (
                        <li>This pokemon evolves via {evo.trigger_name}</li>
                      );
                    case "other":
                      return (
                        <li>This pokemon evolves via {evo.trigger_name}</li>
